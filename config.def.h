...
static const char *fonts[]          = { "Inconsolata for Powerline:size=12", "Inconsolata Nerd Font Complete:size=10" };
...
static const Rule rules[] = {
	...
	*/
	...
	{ "rhythmbox",  	NULL,		NULL,	1 << 7,		0,		0,		0,		-1 },
...
static Key keys[] = {
	...
	{ MODKEY,			XK_Escape,	spawn,		SHCMD("[ \"$(printf \"No\\nYes\" | dmenu -lines 2 -p \"Restart dwm?\")\" = Yes ] && pkill dwm") },
	...
	{ MODKEY,			XK_x,		spawn,		SHCMD("betterlockscreen -l dim -t \">_\"") },
	{ MODKEY|ShiftMask,		XK_x,		spawn,		SHCMD("betterlockscreen -s dim -t \">_\"") },
	...
	{ 0, XF86XK_Sleep,		spawn,		SHCMD("betterlockscreen -s dim -t \">_\"") },
